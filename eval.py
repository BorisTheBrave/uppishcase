...
def none_transform(texts: list[str], tokenizer: PreTrainedTokenizer) -> tuple[t.Tensor, t.Tensor, t.Tensor]:
...
def UPPER_transform(texts: list[str], tokenizer: PreTrainedTokenizer) -> tuple[t.Tensor, t.Tensor, t.Tensor]:
...
def generate_text(text: str,
    ...
    **kwargs
    ...
    inputs, mask, steering = transform_fn([text], tokenizer)
